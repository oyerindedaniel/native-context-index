...
const linkBase =
  "relative border-l-2 border-transparent pl-3 text-base font-semibold tracking-tight text-ink/75 transition-[color,border-color] duration-150 ease-out hover:text-ink focus-visible:rounded-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-primary";
