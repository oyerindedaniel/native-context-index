...
pub struct PackageEntry {
    ...
    pub types_entries: Vec<String>,

    /// Map of subpaths to their resolved `.d.ts` files.
    pub subpaths: HashMap<String, String>,
}
...
pub struct ParsedExport {
    ...
    pub dependencies: Vec<TypeReference>,
...
pub struct CrawlResult {
    ...
    pub imports: HashMap<String, Vec<ParsedImport>>,
    ...
    pub type_reference_packages: Vec<String>,
...
impl ResolvedSymbol {
    pub fn from_export(export: &ParsedExport, defined_in: impl Into<String>) -> Self {
        Self {
